...
// Object to search a team by name and find the id
export const clubBadgeId = [
    // Prem Teams
   {name: 'manchester city', id: 17},
   {name: 'man city', id: 17},
   {name: 'manchester united fc', id: 17},
   {name: 'manchester utd', id: 17},
   {name: 'man utd', id: 17},
   ...
   {name: 'west ham', id: 37},
   {name: 'wolves', id: 3},
   {name: 'wolverhampton wanderers', id: 3},
   {name: 'crystal palace', id: 7},
   {name: 'leicester city"', id: 31},
   {name: 'aston villa', id: 40},
   {name: 'southampton', id: 45},
   {name: 'brighton', id: 30},
   {name: 'brentford', id: 50},
   {name: 'newcastle', id: 39},
   {name: 'leeds', id: 34},
   {name: 'leedsUtd', id: 34},
   {name: 'leedsUnited', id: 34},
   {name: 'everton', id: 48},
   {name: 'burnley', id: 6},
   {name: 'watford', id: 24},
   {name: 'norwich city', id: 263},
   // Serie A Teams
   {name: 'ac milan', id: 2692},
   {name: 'fc internazionale milano', id: 2692},
   {name: 'inter', id: 2692},
   {name: 'ssc napoli', id: 2714},
   {name: 'juventus fc', id: 2687},
   {name: 'as roma', id: 2702},
   {name: 'ss lazio', id: 81783},
   {name: 'ac fiorentina', id: 2693},
   {name: 'atalanta bc', id: 2686},
   {name: 'us sassuolo calcio', id: 2793},
   {name: 'hellas verona fc', id: 2701},
   {name: 'torino fc', id: 2696},
   {name: 'bologna fc 1909', id: 2685},
   {name: 'udinese calcio', id: 2695},
   {name: 'empoli fc', id: 2705},
   {name: 'spezia calcio', id: 2735},
   {name: 'uc sampdoria', id: 2711},
   {name: 'cagliari calcio', id: 2719},
   {name: 'venezia fc', id: 2688},
   {name: 'genoa fc', id: 79111},
   {name: 'us salernitana 1919', id: 2710},
   // Bundesliga Teams
   {name: 'fc bayern münchen', id: 2672},
   {name: 'fc bayern munich', id: 2672},
   {name: 'borussia dortmund', id: 2673},
   {name: 'bayer leverkusen', id: 2529},
   {name: 'rb leipzig', id: 36360},
   {name: 'red bull leipzig', id: 36360},
   {name: 'rasenballsport leipzig', id: 36360},
   {name: 'sc freiburg', id: 2538},
   {name: 'tsg 1899 hoffenheim', id: 2569},
   {name: '1. fc köln', id: 2525},
   {name: '1. fc koln', id: 2525},
   {name: 'eintracht frankfurt', id: 2674},
   {name: '1. fsv mainz 05', id: 2571},
   {name: 'borussia mönchengladbach', id: 2527},
   {name: 'borussia monchengladbach', id: 2527},
   {name: 'vfl bochum 1848', id: 2542},
   {name: 'vfl wolfsburg', id: 43706},
   {name: 'fc augsburg', id: 2600},
   {name: 'vfb stuttgart', id: 2677},
   {name: 'arminia bielefeld', id: 2540},
   {name: 'hertha berlin', id: 43693},
   {name: 'hertha bsc', id: 43693},
   {name: 'spvgg greuther fürth 1903', id: 2551},
   {name: 'spvgg greuther furth 1903', id: 2551},
   //La Liga
   {name: 'real madrid cf', id: 3540},
   {name: 'fc barcelona', id: 2817},
   {name: 'barca', id: 2817},
   {name: 'sevilla fc', id: 77903},
   {name: 'club atlético de madrid', id: 2836},
   {name: 'club atletico de madrid', id: 2836},
   {name: 'real betis balompié', id: 24358},
   {name: 'real sociedad de fútbol', id: 2824},
   {name: 'real sociedad de futbol', id: 2824},
   {name: 'villarreal cf', id: 24338},
   {name: 'athletic club', id: 2825},
   {name: 'athletic bilbao', id: 2825},
   {name: 'valencia cf"', id: 24337},
   {name: 'ca osasuna', id: 2820},
   {name: 'rcd espanyol de barcelona', id: 2814},
   {name: 'rc celta de vigo', id: 2821},
   {name: 'rayo vallecano de madrid', id: 2818},
   {name: 'getafe cf', id: 2859},
   {name: 'elche cf', id: 2846},
   {name: 'granada cf', id: 33779},
   {name: 'rcd mallorca', id: 2826},
   {name: 'cádiz cf', id: 4488},
   {name: 'cadiz cf', id: 4488},
   {name: 'levante ud', id: 2849},
   {name: 'deportivo alavés', id: 2885},
   {name: 'deportivo alaves', id: 2885},
   // Championship Teams
   {name: 'fulham fc', id: 43},
   {name: 'afc bournemouth', id: 60},
   {name: 'huddersfield town afc', id: 59},
   {name: 'nottingham forest fc', id: 14},
   {name: 'luton town fc', id: 72},
   {name: 'sheffield united fc', id: 15},
   {name: 'blackburn rovers fc', id: 46},
   {name: 'middlesbrough fc', id: 36},
   {name: 'millwall fc', id: 36},
   {name: 'coventry city fc', id: 11},
   {name: 'queens park rangers fc', id: 1},
   {name: 'qpr', id: 1},
   {name: 'west bromwich albion fc', id: 8},
   {name: 'preston north end fc', id: 21},
   {name: 'swansea city afc', id: 74},
   {name: 'stoke city fc', id: 29},
   {name: 'blackpool fc', id: 67},
   {name: 'cardiff city fc', id: 61},
   {name: 'birmingham city fc', id: 9},
   {name: 'bristol city fc', id: 76},
   {name: 'hull city afc', id: 96},
   {name: 'barnsley fc', id: 23},
   {name: 'derby county fc', id: 27},
   {name: 'peterborough united fc', id: 54},
   // Ligue 1 Teams
   {name: 'paris saint-germain fc', id: 1644},
   {name: 'paris saint germain fc', id: 1644},
   {name: 'psg', id: 1644},
   {name: 'olympique de marseille', id: 1641},
   {name: 'stade rennais fc 1901', id: 463915},
   {name: 'rennes', id: 463915},
   {name: 'rc strasbourg alsace', id: 495628},
   {name: 'ogc nice', id: 1661},
   {name: 'as monaco fc', id: 1653},
   {name: 'lille ocs', id: 1643},
   {name: 'racing club de lens', id: 1648},
   {name: 'fc nantes', id: 1647},
   {name: 'olympique lyonnais', id: 1649},
   {name: 'lyon fc', id: 1649},
   {name: 'montpellier hsc', id: 5754},
   {name: 'stade brestois 29', id: 1715},
   {name: 'stade de reims', id: 1682},
   {name: 'reims fc', id: 1682},
   {name: 'angers sco', id: 1684},
   {name: 'es troyes ac', id: 1652},
   {name: 'fc lorient', id: 1656},
   {name: 'clermont foot 63', id: 1680},
   {name: 'as saint-étienne', id: 1678},
   {name: 'as saint étienne', id: 1678},
   {name: 'as saint-etienne', id: 1678},
   {name: 'as saint etienn', id: 1678},
   {name: 'fc girondins de bordeaux', id: 1645},
   {name: 'fc metz', id: 1651}
];
